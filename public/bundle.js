...
class Component extends HTMLElement {
  ...
  createBody(data) {
    ...
    return domTemplateStrings`<div id="create-new-tracker">
...
class Component$2 extends HTMLElement {
  ...
  createBody() {
    const button = domTemplateStrings`<button>Button</button>`;
    button.onclick = this.sendMessage;
    const containerElement = domTemplateStrings`<fieldset id="tracker-actions">
...
Engine$1.router.navigate("/new");


setTimeout(() => {
  Engine$1.router.navigate("/old");
}, 1000);
