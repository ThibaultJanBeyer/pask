...
class Component$14 extends HTMLElement {
  ...
  createBody() {
    ...
    const illustration = domTemplateStrings`${this.createSlider(defaultValue)}`;
    const rangeInput = domTemplateStrings`<input min="1" max="100" step="1" value=${defaultValue} type="range" />`;
